...
**Работас удаленными репозиториями - 1**

Смотри информацию выше
...
В декоративных целях заголовки можно «закрывать» обратной стороны.
...
[короткая запись]: http://example.com/
...
Маркдауне нет синтаксиса для таблиц, а в GFM есть.
